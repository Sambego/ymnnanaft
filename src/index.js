...
console.log(
  "The source of this presentation can be found at: https://github.com/sambego/ymnnanaft"
);
console.log("Yes I know, it's all a bit of a hack :)");
console.log(
  "Want to create your own presentations using React components? Check here: https://sambego.github.io/diorama-demo"
);

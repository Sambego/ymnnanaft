...
export default class Location {
  ...
  static getMap(latitude, longitude) {
    ...
    return `https://maps.googleapis.com/maps/api/staticmap?center=${latitude},${longitude}&zoom=${zoom}&size=${size}x${size}&maptype=hybrid&sensor=false&key=${
      this.mapsApiKey
    }`;
  }
